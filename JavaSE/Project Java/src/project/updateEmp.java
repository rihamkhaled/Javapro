...
public class updateEmp  extends JFrame implements ActionListener{
     ...
     public updateEmp(int i){
         //------frame componant------
     data user = obj.getData(i);
     f1=new JFrame();
     labName=new JLabel("Emp_Name");
     f_name=new CustomTextField(10);
     f_name.setPlaceholder(user.getName());
     labId=new JLabel("ID");
     id=new CustomTextField(10);
     id.setPlaceholder(user.getId());
     labPass=new JLabel("Password");
     pass=new CustomTextField(10);
     pass.setPlaceholder(user.getPAS());
     labNId=new JLabel("National_Id");
     n_id=new CustomTextField(10);
     n_id.setPlaceholder(user.getNat());
     labPhone=new JLabel("Phone");
     phone=new CustomTextField(10);
     phone.setPlaceholder(user.getPhone());
     labGender=new JLabel("gender");
     gender=new CustomTextField(10);
     gender.setPlaceholder(user.getGender());
     labAdd=new JLabel("Address");
     add=new CustomTextField(10);
     add.setPlaceholder(user.getAddress());
     labDOB=new JLabel("DOB");
     DOB=new CustomTextField(10);
     DOB.setPlaceholder(user.getDob());
     labPos=new JLabel("Position");
     pos=new CustomTextField(10);
     pos.setPlaceholder(user.getPos());
     labSal=new JLabel("Salary");
     sala=new CustomTextField(10);
     sala.setPlaceholder(user.getSal());
     labBonus=new JLabel("Bouns");
     boun=new CustomTextField(10);
     boun.setPlaceholder(user.getBon());
     //--------------fram-------
